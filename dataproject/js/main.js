...
function BuildLine() {
  ...
  d3.csv("data/CovidExeter.csv",
    ...
    function(data) {
      ...
      d3.csv("data/MeanAnxiety.csv",
        function(d2) {
          return {
            date: d3.timeParse("%d-%b")(d2.date),
            value: parseFloat(d2.GAD)
          }
        },
        ...
        function(dataR) {
          ...
          var lineR = g
            .append("g")
            .append("path")
            .datum(dataR.filter(function(d, i) {
              return i === 0
            }))
            ...
            .on("scroll", function() {
              ...
              if (sp === true) {
                ...
                if (scroll > oldscroll) {
                  ...
                  ft = true;
                  graphCs++;
                  update(data, "Cases of COVID-19 among Exeter students (L) Mean Anxiety (R)", false, df, true);
                  if (activated3 === true) {
                    update(dataR, "Cases of COVID-19 among Exeter students", 10, df2, true, true);
                  }
              ...
              if (sp === false) {
                ...
                var df2 = dataR.filter(function(d, i) {
                  return i <= scroll / 6.55;
                })
              ...
              if (parseInt(scroll) == 15 & activated3 === false) {
                //build axis here
              ...
              if (parseInt(scroll) == 20 & activated === false) {
                ...
                d3.csv("data/MeanDepression.csv",
                  ...
                  function(data) {
                    update(data, "Mean depression scores (PHQ-9) for students", 12.5)
                  })
              ...
              if (parseInt(scroll) == 35 & activated1 === false) {
                ...
                d3.csv("data/MeanLonely.csv",
                  ...
                  function(data) {
                    update(data, "Mean loneliness scores among students", 8)
                  })
          ...
          function update(data, title, max = false, df = data, reset = false, l2 = false) {
